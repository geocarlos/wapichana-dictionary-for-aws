...
import { ArrowBack, Edit, Menu } from '@mui/icons-material';
...
<div className="icon-buttons"><IconButton onClick={() => navigate('/')}><ArrowBack /></IconButton>
...
{word[0].entry}
{isLoggedIn &&
<IconButton style={{ padding: 0 }} onClick={() => navigate(`/editor/${word[0].entry}`)}><Edit /></IconButton>}
</h1>
