...
{isLoggedIn && 
<Button onClick={() => navigate('/editor')} variant="outlined" color="primary" size="small">
Adicionar Palavra
</Button>}
</div>
<ul>
...
{isLoggedIn && <IconButton style={{padding: 0}} onClick={() => navigate(`/editor/${word[0].entry}`)}><Edit /></IconButton>}
<div>
